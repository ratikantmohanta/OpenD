...
```
dfx canister call opend_backend listItem '(principal "qsgjb-riaaa-aaaaa-aaaga-cai", 2)'
```
...
```
dfx canister call qsgjb-riaaa-aaaaa-aaaga-cai transferOwnership '(principal "renrk-eyaaa-aaaaa-aaada-cai", true)'
```
